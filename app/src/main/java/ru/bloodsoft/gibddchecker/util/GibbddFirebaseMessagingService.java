...
public class GibbddFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static final String TAG = makeLogTag(GibbddFirebaseMessagingService.class);
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            if (remoteMessage.getData().size() > 0) {
                sendNotification(remoteMessage.getNotification().getBody(), true);
            } else {
                sendNotification(remoteMessage.getNotification().getBody(), false);
            }
        }
     ...
     */
    private void sendNotification(String messageBody, boolean openReportsScreen) {
